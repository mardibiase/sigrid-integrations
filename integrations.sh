...
COMMANDS=("objectives_report.py" "get_scope_file.py" "export_portfolio_dependencies.py" "polarion-integration.py" "export_github_issues.py" "export_gitlab_issues.py" "osh-findings.py")
