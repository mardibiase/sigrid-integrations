...
class _AbstractPortfolioTreemapPlaceholder(_AbstractTreemapPlaceholder, ABC):
    ...
    def draw_image(cls, width, height, fig_data):
        ...
        tr.treemap(axes=ax, data=df, area="volumes", levels=["root_names", "system_names"], top=True,
                ...
                rectprops={'ec':'w', 'pad':(0,0,0,4)},
                textprops={
                    'fontfamily':'sans-serif', 'reflow':True, 'place':'center', 'grow':True,
                    'max_fontsize':8, 'color':'k', 'pady':1, 'padx':1}, # Text inside squares
                subgroup_rectprops={'root_names':{'ec':'w', 'fc':cls.BUNDLE_COLOR}},
                subgroup_textprops={'root_names':{'place':'top center', 'max_fontsize':6, 'pady':1, 'fontfamily':'sans-serif', 'color':'k'}}
        )
        ax.axis("off")
        return fig
