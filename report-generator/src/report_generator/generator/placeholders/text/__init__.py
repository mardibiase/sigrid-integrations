...
from . import architecture, maintainability, maintainability_portfolio, objectives, metadata, modernization, osh
from .base import parameterized_text_placeholder, text_placeholder

_modules_to_scan = [architecture, maintainability, maintainability_portfolio, metadata, modernization, objectives, osh]
