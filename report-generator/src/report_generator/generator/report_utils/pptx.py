...
VOLUME_POS_CHANGE_RANGE_COLORS = [RGBColor(0xDB, 0xE8, 0xEB), RGBColor(0x71, 0xB6, 0xC9)]
VOLUME_NEG_CHANGE_RANGE_COLORS = [RGBColor(0xED, 0xE6, 0xDB), RGBColor(0xE8, 0x99, 0x36)]

DASHBOARD_EXISTING_FINDINGS_COLOR = RGBColor(0xB8, 0xC3, 0xFA)
DASHBOARD_NEW_FINDINGS_COLOR = RGBColor(0x2D, 0x6B, 0xFF)
DASHBOARD_RESOLVED_FINDINGS_COLOR = RGBColor(0xE9, 0xC3, 0x43)

DASHBOARD_RESOLUTION_NO_RISK_COLOR = DASHBOARD_NEW_FINDINGS_COLOR
DASHBOARD_RESOLUTION_LOW_RISK_COLOR = RGBColor(0xE9, 0xC3, 0x43)
DASHBOARD_RESOLUTION_MEDIUM_RISK_COLOR = RGBColor(0xC9, 0xA8, 0x37)
DASHBOARD_RESOLUTION_HIGH_RISK_COLOR = RGBColor(0xAB, 0x8D, 0x2D)
