...
DASHBOARD_RESOLUTION_SLOW_COLOR = RGBColor(0xE9, 0xC3, 0x43)
DASHBOARD_RESOLUTION_LONG_COLOR = RGBColor(0xC9, 0xA8, 0x37)
DASHBOARD_RESOLUTION_LONGEST_COLOR = RGBColor(0xAB, 0x8D, 0x2D)
