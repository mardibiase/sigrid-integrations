...
class TestTemplates:
    ...
    def test_templates_should_not_use_sigsterren_font(self):
        """
        Test that all templates use the Sigsterren font only for placeholder text.
        
        The Sigsterren font should only be used for placeholder keys (e.g., MAINT_RATING, COLOR_ARCH_RATING).
        It should NOT be used for star display characters or any other text.
        ...
        if fonts_found:
            error_msg = "The following templates use the Sigsterren font for non-placeholder text:\n"
            error_msg += "(Sigsterren font should only be used for placeholder keys, not for star display or other text)\n\n"
                    ...
                    for para in shape.text_frame.paragraphs:
                        for run in para.runs:
                            if run.font.name and self._is_sigsterren_font(run.font.name):
                                if not self._is_placeholder_text(run.text):
                                    fonts_found.append(
    ...
    def _is_placeholder_text(self, text: str) -> bool:
        ...
        placeholder_pattern = r'\b[A-Z][A-Z0-9_]*_[A-Z0-9_]*\b'
